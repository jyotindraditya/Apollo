...
Due to current spotify API policies, we can't use extended quota mode until until it is being used for a large audience by an organization. So we are stuck in development mode ie. I will have to manually put the email ids of the users to allow them to use this app. Feel free to mail me on jyotindraditya@gmail.com
